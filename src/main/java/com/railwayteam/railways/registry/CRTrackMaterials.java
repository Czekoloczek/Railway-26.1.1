...
public class CRTrackMaterials {
    public static final TrackMaterial
        ACACIA = make(Railways.asResource("acacia"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/acacia_planks"))
        ...
        BIRCH = make(Railways.asResource("birch"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/birch_planks"))
        ...
        CRIMSON = make(Railways.asResource("crimson"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/crimson_planks"))
        ...
        DARK_OAK = make(Railways.asResource("dark_oak"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/dark_oak_planks"))
        ...
        JUNGLE = make(Railways.asResource("jungle"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/jungle_planks"))
        ...
        OAK = make(Railways.asResource("oak"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/oak_planks"))
        ...
        SPRUCE = make(Railways.asResource("spruce"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/spruce_planks"))
        ...
        WARPED = make(Railways.asResource("warped"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/warped_planks"))
        ...
        BLACKSTONE = make(Railways.asResource("blackstone"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/blackstone"))
        ...
        MANGROVE = make(Railways.asResource("mangrove"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/mangrove_planks"))
        ...
        CHERRY = make(Railways.asResource("cherry"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/cherry_planks"))
        ...
        BAMBOO = make(Railways.asResource("bamboo"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/bamboo_block"))
        ...
        STRIPPED_BAMBOO = make(Railways.asResource("stripped_bamboo"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/bamboo_planks"))
        ...
        ENDER = make(Railways.asResource("ender"))
            ...
            .particle(ResourceLocation.withDefaultNamespace("block/end_stone"))
